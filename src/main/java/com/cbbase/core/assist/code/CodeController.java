...
public class CodeController extends CodeAssist {
	...
	public static void create(){
		...
		action.append("	@RequestMapping(value = \"selectPage\")").append("\r\n");
		action.append("	@Authority(value = \""+auth_name+".view\")").append("\r\n");
		...
		action.append("\r\n");
		action.append("	@ResponseBody").append("\r\n");
		action.append("	@RequestMapping(value = \"select\")").append("\r\n");
		action.append("	@Authority(value = \""+auth_name+".view\")").append("\r\n");
		...
		action.append("\r\n");
		action.append("	@ResponseBody").append("\r\n");
		action.append("	@RequestMapping(value = \"add\")").append("\r\n");
		...
		action.append("\r\n");
		action.append("	@ResponseBody").append("\r\n");
		action.append("	@RequestMapping(value = \"update\")").append("\r\n");
		action.append("	@Authority(value = \""+auth_name+".modify\")").append("\r\n");
		...
		action.append("\r\n");
		action.append("	@ResponseBody").append("\r\n");
		action.append("	@RequestMapping(value = \"delete\")").append("\r\n");
		action.append("	@Authority(value = \""+auth_name+".modify\")").append("\r\n");
