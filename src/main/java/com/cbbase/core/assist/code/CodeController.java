...
public class CodeController extends CodeAssist {
	...
	public static void create(){
		...
		action.append("	@RequestMapping(value = \"selectPage.do\")").append("\r\n");
		...
		action.append("\r\n");
		action.append("	@ResponseBody").append("\r\n");
		action.append("	@RequestMapping(value = \"select.do\")").append("\r\n");
		action.append("	@Authority(value = \""+auth_name+".view\")").append("\r\n");
		...
		action.append("\r\n");
		action.append("	@ResponseBody").append("\r\n");
		action.append("	@RequestMapping(value = \"add.do\")").append("\r\n");
		...
		action.append("\r\n");
		action.append("	@ResponseBody").append("\r\n");
		action.append("	@RequestMapping(value = \"update.do\")").append("\r\n");
		action.append("	@Authority(value = \""+auth_name+".modify\")").append("\r\n");
