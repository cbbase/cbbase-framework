...
public class CodeJsp extends CodeAssist {
	...
	public static void create(){
		...
		jsp_index.append("	    	,url: basePath+'/"+model_path+"/selectPage.do' //数据接口").append("\r\n");
		...
		jsp_index.append("		doFormRequest(\"addForm\", basePath+\"/"+model_path+"/add.do\", function(){").append("\r\n");
		...
		jsp_index.append("		doFormRequest(\"updateForm\", basePath+\"/"+model_path+"/update.do\", function(){").append("\r\n");
		jsp_index.append("			layer.close(layer.index);").append("\r\n");
		jsp_index.append("			reloadTable();").append("\r\n");
		jsp_index.append("		});").append("\r\n");
		jsp_index.append("	}").append("\r\n");
		...
		jsp_index.append("			doParamRequest({\"ids\": ids}, basePath+'/"+model_path+"/delete.do', reloadTable);").append("\r\n");
		jsp_index.append("		});").append("\r\n");
		jsp_index.append("	}").append("\r\n");
		jsp_index.append("	").append("\r\n");
		...
		jsp_update.append("		initFormData(\"updateForm\", basePath+\"/"+model_path+"/select.do\", {\"id\":id});").append("\r\n");
		jsp_update.append("	})").append("\r\n");
		jsp_update.append("	").append("\r\n");
