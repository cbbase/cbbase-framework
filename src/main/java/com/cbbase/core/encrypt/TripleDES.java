...
public class TripleDES{
	...
	public static byte[] encrypt(byte[] strKey, byte[] strEncData) {
		return hex2byte(TripleDES.encrypt(byte2hex(strKey), byte2hex(strEncData)).getBytes());
	}
	
	public static String encrypt(String strKey, String strEncData) {
		String strKey1;
		String strKey2;
		String strTemp1;
		String strTemp2;
		if(strEncData.length() == 16){
			strEncData = strEncData + strEncData;
		}
	 ...
	 * @return
	 */
	public static String decrypt(String strKey, String strEncData) {
		String strKey1;
		String strKey2;
		String strTemp1;
		String strTemp2;
